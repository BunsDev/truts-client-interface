                    ...
                    <div className={styles.contentCon}>
                        ...
                        <div className={styles.rightNav}>
                            <div className={styles.socials} id={"rightPane"}>
                                ...
                                >
                                    <img src="/web-outline.png" alt="" />
                                    <p >{(dao_data.mirror_link?.length > 1) ? "other links" : "n/a"}</p>
                                </button>
    ...
    return (
        <div className={cmtStyle}>
            ...
            <div className={styles.likes}>
                ...
                { <span>
                    <img src="/share.png" alt="" onClick={() => { openNewTab(`http://twitter.com/share?text=Check out this ${data.rating}⭐ review for ${data.dao_name} (@${twitter_slug}) on @trutsxyz  &hashtags=truts,${unspacedDaoName},WAGMI &url=https://www.truts.xyz/dao/${slug}/${data._id}`) }} />
                </span> }
            </div>
        </div>
    )
